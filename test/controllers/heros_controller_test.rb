...
class HerosControllerTest < ActionController::TestCase
  ...
  test "should create hero" do
    assert_difference('Hero.count') do
      post :create, hero: { agility: @hero.agility, experience: @hero.experience, intelligence: @hero.intelligence, npc_id: @hero.npc_id, strength: @hero.strength }
    end
  ...
  test "should update hero" do
    patch :update, id: @hero, hero: { agility: @hero.agility, experience: @hero.experience, intelligence: @hero.intelligence, npc_id: @hero.npc_id, strength: @hero.strength }
    assert_redirected_to hero_path(assigns(:hero))
  end
